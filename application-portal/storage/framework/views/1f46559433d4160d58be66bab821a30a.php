        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="card-custom p-4">
                    ...
                    <form id="applicationForm" method="POST" action="<?php echo e(route('apply.submit')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>

                        <input type="hidden" name="application_type_id" id="application_type_id" value="">

                        <!-- Application Type Selection -->
                        <?php if($applicationTypes->count() > 0): ?>
                        <div class="wizard-step active" data-step="0">
                            <h4 class="mb-4"><i class="bi bi-files-alt me-2"></i>Select Application Type</h4>
                            <div class="row g-3 mb-4">
                                <?php $__currentLoopData = $applicationTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-6">
                                    <div class="card application-type-card" data-type-id="<?php echo e($type->id); ?>" onclick="selectApplicationType(<?php echo e($type->id); ?>, <?php echo e($type->id); ?>)">
                                        <div class="card-body text-center py-4">
                                            <i class="bi bi-files-alt fs-1 text-primary mb-3"></i>
                                            <h5><?php echo e($type->name); ?></h5>
                                            <p class="text-muted mb-0"><?php echo e($type->description); ?></p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="wizard-step" data-step="2">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" name="graduation_year" class="form-control" min="1950" max="<?php echo e(date('Y')); ?>" required>
                                </div>
                            </div>
                        ...
                        <div class="wizard-step" data-step="6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="<?php echo e(date('F j, Y')); ?>" readonly>
                            </div>
...
<script>
    ...
    $('input[type="file"]').change(function() {
        ...
        if (this.files && this.files[0]) {
            ...
            zone.find('p').text(this.files[0].name);
        }
    });
    ...
    const applicationTypes = <?php echo json_encode($applicationTypes->keyBy('id'), 15, 512) ?>;
    ...
    <?php if($applicationTypes->count() === 1): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dwealth\Documents\application\application-portal\resources\views/frontend/apply.blade.php ENDPATH**/ ?>