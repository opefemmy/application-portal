            ...
            <div class="stat-card mb-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="hero_subtitle" class="form-control" value="{{ $content['hero_subtitle'] ?? '' }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Button Text</label>
                        <input type="text" name="hero_button_text" class="form-control" value="{{ $content['hero_button_text'] ?? '' }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Button Link</label>
                        <input type="text" name="hero_button_link" class="form-control" value="{{ $content['hero_button_link'] ?? '' }}">
                    </div>
                </div>
            </div>
            @endif
            ...
            <div class="stat-card mb-4">
                ...
                <div class="row">
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" name="stats_applications" class="form-control" value="{{ $content['stats_applications'] ?? '' }}">
                    </div>
                    <div class="col-md-3 mb-3">
                        <label class="form-label">Successful Applicants</label>
                        <input type="text" name="stats_successful" class="form-control" value="{{ $content['stats_successful'] ?? '' }}">
                    </div>
                    <div class="col-md-3 mb-3">
                        <label class="form-label">Partner Institutions</label>
                        <input type="text" name="stats_partners" class="form-control" value="{{ $content['stats_partners'] ?? '' }}">
                    </div>
                    <div class="col-md-3 mb-3">
                        <label class="form-label">Support Quality</label>
                        <input type="text" name="stats_quality" class="form-control" value="{{ $content['stats_quality'] ?? '' }}">
                    </div>
                </div>
            </div>
            ...
            <div class="stat-card mb-4">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="feature_title" class="form-control" value="{{ $content['feature_title'] ?? '' }}">
                    </div>
                    <div class="col-md-12 mb-3">
                        <label class="form-label">Section Subtitle</label>
                        <input type="text" name="feature_subtitle" class="form-control" value="{{ $content['feature_subtitle'] ?? '' }}">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Feature 1 Title</label>
                        <input type="text" name="feature_1_title" class="form-control" value="{{ $content['feature_1_title'] ?? '' }}">
                    </div>
                    <div class="col-md-8 mb-3">
                        <label class="form-label">Feature 1 Description</label>
                        <textarea name="feature_1_desc" class="form-control" rows="2">{{ $content['feature_1_desc'] ?? '' }}</textarea>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Feature 2 Title</label>
                        <input type="text" name="feature_2_title" class="form-control" value="{{ $content['feature_2_title'] ?? '' }}">
                    </div>
                    <div class="col-md-8 mb-3">
                        <label class="form-label">Feature 2 Description</label>
                        <textarea name="feature_2_desc" class="form-control" rows="2">{{ $content['feature_2_desc'] ?? '' }}</textarea>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Feature 3 Title</label>
                        <input type="text" name="feature_3_title" class="form-control" value="{{ $content['feature_3_title'] ?? '' }}">
                    </div>
                    <div class="col-md-8 mb-3">
                        <label class="form-label">Feature 3 Description</label>
                        <textarea name="feature_3_desc" class="form-control" rows="2">{{ $content['feature_3_desc'] ?? '' }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="stat-card mb-4">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="step_1_title" class="form-control" value="{{ $content['step_1_title'] ?? '' }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Step 1 Description</label>
                        <input type="text" name="step_1_desc" class="form-control" value="{{ $content['step_1_desc'] ?? '' }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Step 2 Title</label>
                        <input type="text" name="step_2_title" class="form-control" value="{{ $content['step_2_title'] ?? '' }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Step 2 Description</label>
                        <input type="text" name="step_2_desc" class="form-control" value="{{ $content['step_2_desc'] ?? '' }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Step 3 Title</label>
                        <input type="text" name="step_3_title" class="form-control" value="{{ $content['step_3_title'] ?? '' }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Step 3 Description</label>
                        <input type="text" name="step_3_desc" class="form-control" value="{{ $content['step_3_desc'] ?? '' }}">
                    </div>
                </div>
            </div>
            ...
            <div class="stat-card mb-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="cta_subtitle" class="form-control" value="{{ $content['cta_subtitle'] ?? '' }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">CTA Button Text</label>
                        <input type="text" name="cta_button_text" class="form-control" value="{{ $content['cta_button_text'] ?? '' }}">
                    </div>
                </div>
            </div>
            @endif
            ...
            <div class="stat-card mb-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="contact_address" class="form-control" rows="3">{{ $content['contact_address'] ?? '' }}</textarea>
                    </div>
                </div>
            </div>
            @endif
            ...
            <div class="stat-card mb-4">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="footer_text" class="form-control" value="{{ $content['footer_text'] ?? '' }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Contact Email</label>
                        <input type="email" name="contact_email" class="form-control" value="{{ $content['contact_email'] ?? '' }}">
