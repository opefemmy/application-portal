...
@section('title', 'Branding & Rebranding')
...
<div class="row">
            ...
            <form method="POST" action="{{ route('admin.settings.branding.update') }}" enctype="multipart/form-data">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="border rounded p-2 text-center" style="min-height: 100px;" id="logo-preview-container">
                            @if($settings['logo'] ?? false)
                                <img src="{{ asset($settings['logo']) }}" alt="Logo" class="img-fluid" id="logo-preview" style="max-height: 80px;">
                            @else
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="border rounded p-2 text-center" style="min-height: 100px;" id="favicon-preview-container">
                            @if($settings['favicon'] ?? false)
                                <img src="{{ asset($settings['favicon']) }}" alt="Favicon" class="img-fluid" id="favicon-preview" style="max-height: 80px;">
                            @else
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="border rounded p-2 text-center" style="min-height: 100px;" id="footer_logo-preview-container">
                            @if($settings['footer_logo'] ?? false)
                                <img src="{{ asset($settings['footer_logo']) }}" alt="Footer Logo" class="img-fluid" id="footer_logo-preview" style="max-height: 80px;">
                            @else
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="border rounded p-2 text-center" style="min-height: 150px;" id="login_background-preview-container">
                            @if($settings['login_background'] ?? false)
                                <img src="{{ asset($settings['login_background']) }}" alt="Background" class="img-fluid" id="login_background-preview" style="max-height: 130px;">
                            @else
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            <input type="color" name="primary_color" class="form-control form-control-color" value="{{ $settings['primary_color'] ?? '#38488e' }}">
                            <input type="text" class="form-control" value="{{ $settings['primary_color'] ?? '#38488e' }}" readonly>
                        </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            <input type="color" name="secondary_color" class="form-control form-control-color" value="{{ $settings['secondary_color'] ?? '#4052a0' }}">
                            <input type="text" class="form-control" value="{{ $settings['secondary_color'] ?? '#4052a0' }}" readonly>
                        </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            <input type="color" name="accent_color" class="form-control form-control-color" value="{{ $settings['accent_color'] ?? '#fcb900' }}">
                            <input type="text" class="form-control" value="{{ $settings['accent_color'] ?? '#fcb900' }}" readonly>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            <input type="color" name="header_text_color" class="form-control form-control-color" value="{{ $settings['header_text_color'] ?? '#ffffff' }}">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            <input type="color" name="footer_text_color" class="form-control form-control-color" value="{{ $settings['footer_text_color'] ?? '#ffffff' }}">
    ...
    <div class="col-md-4">
        ...
        <div class="stat-card mb-4">
            ...
            <div class="border rounded p-3" style="background: linear-gradient(135deg, {{ $settings['primary_color'] ?? '#38488e' }} 0%, {{ $settings['secondary_color'] ?? '#4052a0' }} 100%);">
                <div class="text-white p-3 rounded" style="background: rgba(255,255,255,0.1);">
                    <h5 class="mb-1">
                        @if($settings['logo'] ?? false)
                            <img src="{{ asset($settings['logo']) }}" alt="Logo" height="30">
                        @else
                ...
                <div class="mt-3">
                    <button class="btn btn-sm" style="background: {{ $settings['accent_color'] ?? '#fcb900' }}; color: #000;">Primary Button</button>
                </div>
            </div>
        </div>
